...
export interface DisplaySettings { slideDuration:number; transitionDuration:number; messageRotationTime:number; infoPanelWidth:number; slides:string[] }
export const DEFAULT_SETTINGS: DisplaySettings = { slideDuration:10, transitionDuration:800, messageRotationTime:10, infoPanelWidth:34, slides:[] };
